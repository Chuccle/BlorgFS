...
typedef struct BLORGFS_VDO_DEVICE_EXTENSION
{
    ...
    PDCB RootDcb;
    PVCB Vcb;
    PBLORGFS_STATISTICS Statistics;
...
CHECK_PADDING_BETWEEN(BLORGFS_VDO_DEVICE_EXTENSION, Vcb, Statistics);
CHECK_PADDING_END(BLORGFS_VDO_DEVICE_EXTENSION, Statistics);
